(function () {
    ...
    div.outerHTML = "<div id='botDiv' style='height: "+minHeight+"px; width: "+minWidth+"px; position: fixed; bottom: 10px; right:10px; z-index: 1000; background-color: transparent; overflow:hidden;border-radius: 15px!important;padding:0px!important; margin:0px!important ;' >" +
    					...
    					"<div id='botFrame' style='margin: 0px 0px 0px -7px;'><iframe style='border-width: 0px; margin: 0px 0px 0px 0px; width:"+maxWidth+"px;height:"+maxHeight+"px;' width='"+maxWidth+"px' height='"+maxHeight+"px' src='https://api.lalittanwar.com/agent/pub/customer/plugin.bubble?page=plugin.bubble'></iframe>" +
    				"<div></div>"; 
