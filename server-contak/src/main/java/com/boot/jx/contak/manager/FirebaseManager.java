...
public class FirebaseManager {
	...
	public void sendNotification(String number, String title, String body, HashMap<String, String> data) {
		...
		String response = restService.ajax("https://fcm.googleapis.com/fcm/send").header("Authorization",
				"key=AAAA13CquBk:APA91bFwITuk9RjqKHP_5b0yR1YacM7cVAK6VUpWIfSTXh5ySYB9egacKwfs8qFk238pZG_cQI1PxtOpmuFYGY32EF1LD9NMHCXk8b0o75n0Y4RVQmRRDMRjM835YA4E7XFxx_QoHrPL")
				.header("Content-Type", "application/json").post(JsonUtil.toJson(bodyObject)).asString();
