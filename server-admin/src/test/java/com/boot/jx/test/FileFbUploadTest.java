...
public class FileFbUploadTest { // Noncompliant
	...
	private static Logger LOGGER = LoggerFactory.getLogger(FileFbUploadTest.class);
...
//
		...
		try {
			...
			String finalResponse = secondApiCall(id, fileData, fileName, fileType);
	...
	private static String firstApiCall(byte[] fileData, String fileName, String fileType, int fileLength,
			String uploadUrl) throws IOException {
