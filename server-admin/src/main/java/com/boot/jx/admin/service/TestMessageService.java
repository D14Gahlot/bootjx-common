...
public class TestMessageService {
	...
	public static Logger LOGGER = LoggerService.getLogger(TestMessageService.class);
	...
	public boolean read(BatchJob currentBatchJob) {
		...
		for (MessageDoc messageDoc : msgs) {
			execute(currentBatchJob, JobTaskModel.newTasklet(currentBatchJob).taskId(messageDoc.getMessageId()));
