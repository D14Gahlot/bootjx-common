...
public class GupShupDeliveryResp implements Serializable {
	...
	public static class GupShupDeliveryDto implements Serializable {
		...
		@ApiMockModelProperty(example = "3562707498794989059-328736121207676738", value = "Unique ID for each message 'causeId-msgId'")
		private String externalId;

		@ApiMockModelProperty(example = "DELIVERED", value = "Final status of the message", allowableValues = "SENT, DELIVERED, READ, FAILED")
		...
		@ApiMockModelProperty(example = "919223399999", value = "In case of WhatsApp, this is WhatsApp Business phone number.")
		private String srcAddr;

		@ApiMockModelProperty(example = "SUCCESS", value = "This is the response you will get depending on the eventType. Various"
				+ " causes and their explanation are below.", allowableValues = "SUCCESS, SENT, READ, OTHER,UNKNOWN_SUBSCRIBER,DEFERRED,BLOCKED_FOR_USER")
		private String cause;

		@ApiMockModelProperty(example = "25", value = "error code assigned to different delivery failure causes,")
		private String errorCode;

		@ApiMockModelProperty(example = "DELIVERED", value = "Final status of the message", allowableValues = "WHATSAPP, SMS")
