...
public class OAPlugin implements DefaultChannelPlugin<OAConfigDetails> {
	...
	public static class OAConfigDetails extends AChannelDetails {
		...
		@ConfigMetaProperty(path = "oa.clientId", title = "Client ID", defaultValue = "wecare")
		private String clientId;

		@ConfigMetaProperty(path = "oa.orgId", title = "Organization Id", defaultValue = "638906d42fc1536f19eb5901",
				inputType = INPUT_TYPE.TEXT)
		private String orgId;

		@ConfigMetaProperty(path = "oa.apiId", title = "API Id", desc = "Enter Your OA API Id")
		private String apiId;

		@ConfigMetaProperty(path = "oa.apiKey", title = "API Key", writeonly = true, desc = "Enter Your OA API Key")
