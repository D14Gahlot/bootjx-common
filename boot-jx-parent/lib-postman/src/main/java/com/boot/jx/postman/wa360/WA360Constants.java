...
public class WA360Constants {
	...
	public static class InBoundWrapperPaths {
		...
		public static final JsonPath INTERACTIVE_NFM_REPLY_RESPONSE_JSON = new JsonPath("messages/[0]/interactive/nfm_reply/response_json");
		public static final JsonPath INTERACTIVE_NFM_REPLY_BODY =new JsonPath ("messages/[0]/interactive/nfm_reply/body");
