...
public class AmxFieldError implements Serializable {
	...
	public AmxFieldError descriptionKey(Object key) {
		this.descriptionKey = ArgUtil.parseAsString(key);
		return this;
	}

	public AmxFieldError descriptionArgs(Object... key) {
		this.descriptionArgs = key;
		return this;
	}

	public AmxFieldError description(String description) {
		this.description = description;
		return this;
	}

	public AmxFieldError code(IExceptionEnum enumCode) {
		this.code = ArgUtil.parseAsString(enumCode.getStatusCode());
		this.codeKey = enumCode.getStatusKey();
		return this;
	}

	public AmxFieldError codeKey(String codeKey) {
		this.codeKey = codeKey;
		return this;
	}

	public AmxFieldError code(int code) {
