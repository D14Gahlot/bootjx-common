...
public class SplitterTest { // Noncompliant
    ...
    public static final String CDN_URL = "https://cdn.jsdelivr.net/gh/mehery-soccom/mehery-web-dist@1a4faca383289168e9d12836041fcd22b7fa6c3c/dist/";
	...
	Matcher matcher = pattern.matcher(CDN_URL);

	if (matcher.find()) {
	    System.out.println(matcher.group(1));
	    System.out.println(matcher.group(2));
	    System.out.println(matcher.group(3));
	    System.out.println(String.format("%scdn.jsdelivr.net/%s@%s/dist/", matcher.group(1), matcher.group(2),
		    matcher.group(3))
