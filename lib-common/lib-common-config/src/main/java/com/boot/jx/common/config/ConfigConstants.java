...
public class ConfigConstants {
	...
	public static enum SETUP_KEY implements EntryMeta {
		...
		POSTMAN_AGENT_OTP_2FA(new ConfigMeta("Enable 2FA for Login", PROPERTIES.POSTMAN_AGENT_2FA_ENABLED)
				.superKey("postman.agent.2fa").desc("You will need OA app").optionsOnOff()),

		POSTMAN_AGENT_OTP_CHANNEL(
				new ConfigMeta("OTP Channel", PROPERTIES.POSTMAN_AGENT_2FA_CHANNEL).superKey("postman.agent.2fa")
